<%-- 
    ...
    Created on : 2 Jun 2023, 12:39:54 am
    Author     : HP
--%>
...
<!--           if(session.getAttribute("admin")==null){
    ...
    <body>
        ...
        <div class="container" >
            <h1 class="mt-4 mb-4">List Of Feedback</h1>
            <table class="table align-middle mb-0 bg-white">
                ...
                <td><%=feedback.getFeed()%></td>
                
                
                <td class="next">
                    <div style="display: inline; margin-left:auto; margin-right:auto;">

                        <form style="display: inline; margin-right: 10px" action="<%=request.getContextPath()%>/FeedbackController">
                            ...
                            <input name="feedbackid" type="hidden" value="<%=feedback.getFeedbackid()%>">
                        </form>
                    </div>
                </td>
